...
import com.example.menu_electronics.repository.authenRepository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        if (user.getStatus().equals("Inactive")) throw new AppException(ErrorCode.UNAUTHENTICATED);
    ...
    public AuthenticationResponse authenticateSignUp(User user) {
        var token = generateToken(user);
